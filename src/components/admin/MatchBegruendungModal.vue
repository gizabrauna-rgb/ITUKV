      ...
      <main class="p-5 max-h-[65vh] overflow-y-auto">
        ...
        <div v-else>
          ...
          <div v-if="pro.length" class="mb-3">
            <h5 class="text-xs font-semibold text-green-700 uppercase tracking-wide mb-1.5">✓ Spricht dafür</h5>
            <ul class="space-y-1">
          ...
          <div v-if="contra.length">
            <h5 class="text-xs font-semibold text-red-700 uppercase tracking-wide mb-1.5">✗ Spricht dagegen</h5>
            <ul class="space-y-1">
